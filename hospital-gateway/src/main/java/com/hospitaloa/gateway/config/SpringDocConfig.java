package com.hospitaloa.gateway.config;
...
class SwaggerDocRegister extends Subscriber<InstancesChangeEvent>
{
    ...
    private final static String[] EXCLUDE_ROUTES = new String[] { "hospital-gateway", "hospital-auth", "hospital-file", "hospital-monitor" };
